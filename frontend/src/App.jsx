...
const [weatherLoading, setWeatherLoading] = useState(false)
  ...
  useEffect(() => {
    fetch("https://smart-tourism-jharkhand.onrender.com/api/places/")
      .then(res => res.json())
  ...
  function generateItinerary() {
    setLoading(true)
    fetch("https://smart-tourism-jharkhand.onrender.com/api/itinerary/", {
      method: "POST",
  ...
  fetch(`https://smart-tourism-jharkhand.onrender.com/api/weather/?district=${district}`)
    .then(res => res.json())
    .then(data => {
